#!/bin/bash
#Wifi-Jammer v1.0
#Coded by:RM Rony Ali
#Telegram : @SHT7669
#Tool to Jamm Wifi with colourful Outfit

#------------------------------------------------------#
# Author                 RM Rony Ali                 #
# Instagram              saikoboy7669                  #
# Github                https://github.com/rm7669 #
#      Saiko Hacker Team {R.M}!!                        #
#------------------------------------------------------#
--------#
...
echo "        [ BY: RM Rony Ali| Telegram: @SHT7669 | v1.0 ]" | pv -qL 40 | lolcat
...
echo -e "                             [ BY: RM Rony Ali| Instagram: saikoboy7669 | v1.0 ]\n" | pv -qL 20 | lolcat
